...
При выставлении кол-ва реплик = 0, существуюащя пода умрет. При значении = 1, пода снова поднимется. После рестарта поды по дефолту придется заново проходить авторизацию + пропадут загруженные или измененные файлы, так как поды эфемерны. Чтобы такого не было, мы добавили PVC
...
<img width="727" height="543" alt="Снимок экрана 2025-12-21 в 19 43 11" src="https://github.com/user-attachments/assets/1065f83f-81f2-4d9a-b6ce-fc65369a3222" />

nextcloud:

<img width="741" height="509" alt="Снимок экрана 2025-12-21 в 19 56 10" src="https://github.com/user-attachments/assets/9302db68-2f9f-4bb9-a860-23c423e73574" />


<img width="925" height="738" alt="Снимок экрана 2025-12-21 в 19 56 35" src="https://github.com/user-attachments/assets/2134bf7f-8254-4bb6-9b6b-eb8c1b998afc" />
